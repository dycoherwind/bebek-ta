    ...
    <div class="card w-50 mx-auto" id="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm mr-auto">
                 ...
                 <div class="col-sm ml-5">
                     <p class="text-right">Bebek Retorasi <br>Jl. Godean km 7.5, RT 06/03 <br> Godean, Sleman <br>Telp:089515338394</p>
                 </div>
            ...
            <div class="w-50 mt-3 mx-auto d-flex justify-content-end pr-4 pb-2">
              <img src="{{ asset('img/logo45.png') }}" width="90px" height="50px" alt="">
            </div>
