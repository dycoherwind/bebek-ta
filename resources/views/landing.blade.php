...
<div class="container mb-3 py-4">
    <div>
        ...
        <div class="d-flex">
            ...
            <button type="button" onclick="detail('{{ $item->id }}')" class="card text-decoration-none text-muted" style="width: 18rem; border: none;">
        ...
        <section id="about">
            <div class="row justify">
                ...
                <div class="col p-4 mt-5 ml-4 mr-5 offset-mr-1" style="margin-left: 100px">
                    <h4 class="text-center" style="color: #4a4d58; font-family: 'Times New Roman', Times, serif">Tentang Kita</h4>
        ...
        <div class="justify-content-center">
            <div class="md-6 mt-4">
                <div class="d-flex justify-content-center flex-row">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" style="color: #4a4d58" class="bi bi-award" viewBox="0 0 16 16">
                    ...
                    <div class="mx-4"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" style="color: #4a4d58" fill="currentColor" class="bi bi-person-heart" viewBox="0 0 16 16">
                    ...
                    <div class="mx-4"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" style="color: #4a4d58" class="bi bi-balloon-heart" viewBox="0 0 16 16">
                ...
                <div class="mt-5"></div>
                <div class="d-flex justify-content-center flex-row">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" style="color: #4a4d58" class="bi bi-alarm" viewBox="0 0 16 16">
                    ...
                    <div class="mx-4"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-chat" style="color: #4a4d58" viewBox="0 0 16 16">
            ...
            <div class="row justify">
                <div class="col-md-6 ml-4 float-center p-4">
                    <div class="mt-2 ml-4 px-5 py-5">
                        <h4 class="mb-4" style="color: #4a4d58; font-family: 'Times New Roman', Times, serif">Contact Us</h4>
                        <div class="d-flex mb-2"></div>
                        <div class="d-flex mb-4">
                            <div onclick="email()" class="d-flex align-items-center text-decoration-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" style="color: b#4a4d58" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                        ...
                        <div class="d-flex mb-4">
                            <div onclick="instagram()" class="d-flex align-items-center text-decoration-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" style="color: #4a4d58" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        <div class="d-flex mb-4">
                            <div onclick="whatsapp()" class="d-flex align-items-center text-decoration-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" style="color: #4a4d58" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
